...
#Limpiamos y consolidamos los nombres de los países, ya que algunos están mal escritos y salen doble
df_filtrado['País'] = df_filtrado['País'].str.lower().replace({'mexico': 'méxico', 'peru': 'perú', 'espana': 'españa'})
...
output_path = '/content/gráfico_visualizaciones.html'
