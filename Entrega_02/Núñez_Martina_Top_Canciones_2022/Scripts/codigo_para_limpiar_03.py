...
Identificar cuáles de los siguientes artistas urbanos chilenos: "Pailita", "Polimá Westcoast", "Paloma Mami", "Cris Mj", "Ak4:20", "Standly", "Julianno Sosa" y "King Savagge", son los más escuchados dentro de los países seleccionados en la plataforma de Spotify.
"""

import pandas as pd

#Cargamos el archivo CSV en un DataFrame.
Base_de_datos_original = pd.read_csv('/content/drive/MyDrive/BASES DE DATOS/base_de_datos_original_2022.csv')

#Lista de nombres de los artistas urbanos chilenos que deseamos buscar.
nombres_artistas_urbanos_chilenos = ["Pailita", "Polimá Westcoast", "Paloma Mami", "Cris Mj", "Ak4:20", "Standly", "Julianno Sosa", "King Savagge"]
